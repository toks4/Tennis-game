let canvas = document.getElementById('gameCanvas'),
    ...
    audio2 = new Audio("https://www.epidemicsound.com/track/yFVhyyhaLQ/");  
    gamePaused = false,
...
function drawEverything() {
  ...
  canvasCtx.beginPath();
  canvasCtx.arc(ballPositionX, ballPositionY, ballSize/2, 0, Math.PI*2, true);
  canvasCtx.fill();
  
  canvasCtx.fillStyle = 'white';
  canvasCtx.fillRect(paddleWidth,paddleOneY,paddleWidth,paddleHeight); // x, y, w, h
  
  canvasCtx.fillStyle = 'white';
  canvasCtx.fillRect(canvas.width - paddleWidth - paddleWidth,paddleTwoY,paddleWidth,paddleHeight); // x, y, w, h
  
  canvasCtx.fillStyle = 'rgba(255,255,255,0.2)';
  canvasCtx.font = "200px 'Roboto', Arial";
  canvasCtx.textAlign = "center";
  canvasCtx.fillText(playerOneScore,canvas.width*.25,canvas.height/2 + 75);

  canvasCtx.fillStyle = 'rgba(255,255,255,0.2)';
  canvasCtx .font = "200px 'Roboto', Arial";
  canvasCtx.textAlign = "center";
  canvasCtx.fillText(playerTwoScore,canvas.width*.75,canvas.height/2 + 75);
